...
This project and all those participating in it are governed by the [Digital Catapult's Code of Conduct](CODE_OF_CONDUCT.md). By participating, you are expected to uphold this code. Please report unacceptable behavior to [{PROJECT_NAME}supprt@github.com](mailto:{PROJECT_NAME}support@github.com).
...
[{PROJECT_NAME} Project Documentation](https://github.com/CDECatapult/{PROJECT_NAME}-documentation)

{PROJECT_MODULE_NAME} is a small open source project &mdash; [{PROJECT_MODULE_NAME}](https://github.com/CDECatapult/{PROJECT_MODULE_NAME}). When you initially consider contributing to {PROJECT_MODULE_NAME}, this section should help you with doing so.
...
Before creating bug reports, please check [this list](#before-submitting-a-bug-report) as you might find out that you don't need to create one. When you are creating a bug report, please [include as many details as possible](#how-do-i-submit-a-good-bug-report). Fill out [the required template](https://github.com/CDECatapult/{PROJECT_MODULE_NAME}/blob/master/.github/ISSUE_TEMPLATE/bug_report.md), the information it asks for helps us resolve issues faster.
...
Bugs are tracked as [GitHub issues](https://guides.github.com/features/issues/). Create an issue on that repository and provide the following information by filling in [the template](https://github.com/CDECatapult/{PROJECT_MODULE_NAME}/.github/blob/master/.github/ISSUE_TEMPLATE/bug_report.md).
...
Before creating enhancement suggestions, please check [this list](#before-submitting-an-enhancement-suggestion) as you might find out that you don't need to create one. When you are creating an enhancement suggestion, please [include as many details as possible](#how-do-i-submit-a-good-enhancement-suggestion). Fill in [the template](https://github.com/CDECatapult/{PROJECT_MODULE_NAME}/blob/master/.github/ISSUE_TEMPLATE/feature_request.md), including the steps that you imagine you would take if the feature you're requesting existed.
